...
url_template <- 'https://www.imdb.com/title/tt1013752/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Fast & Furious", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie1_imdb_reviews.csv", row.names = FALSE)
```
