...
url_template <- 'https://www.imdb.com/title/tt2283362/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Jumanji: Welcome to the Jungle", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie10_imdb_reviews.csv", row.names = FALSE)
```
