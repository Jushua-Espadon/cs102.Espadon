...
url_template <- 'https://www.imdb.com/title/tt6443346/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Black Adam", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movei2_imdb_reviews.csv", row.names = FALSE)
```
