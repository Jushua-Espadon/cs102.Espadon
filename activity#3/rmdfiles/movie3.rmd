...
url_template <- 'https://www.imdb.com/title/tt3606756/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Incredibles 2", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movei3_imdb_reviews.csv", row.names = FALSE)
```
