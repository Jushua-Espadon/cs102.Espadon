...
url_template <- 'https://www.imdb.com/title/tt3717490/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Power Rangers", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movei4_imdb_reviews.csv", row.names = FALSE)
```
