...
url_template <- 'https://www.imdb.com/title/tt3682448/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Bridge of Spies", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie5_imdb_reviews.csv", row.names = FALSE)
```
