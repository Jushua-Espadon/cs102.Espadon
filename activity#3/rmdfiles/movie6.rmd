...
url_template <- 'https://www.imdb.com/title/tt0371746/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Iron Man", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie6_imdb_reviews.csv", row.names = FALSE)
```
