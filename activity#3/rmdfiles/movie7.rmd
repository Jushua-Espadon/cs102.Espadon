...
url_template <- 'https://www.imdb.com/title/tt2120120/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Pixels", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie7_imdb_reviews.csv", row.names = FALSE)
```
