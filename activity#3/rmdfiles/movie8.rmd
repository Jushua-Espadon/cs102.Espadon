...
url_template <- 'https://www.imdb.com/title/tt4154664/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Captain Marvel", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie8_imdb_reviews.csv", row.names = FALSE)
```
