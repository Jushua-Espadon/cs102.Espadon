...
url_template <- 'https://www.imdb.com/title/tt1228705/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Iron Man 2", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie9_imdb_reviews.csv", row.names = FALSE)
```
